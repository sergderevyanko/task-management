...
class UpdateProjectTask extends Component {
    ...
    componentDidMount() {
        const {projectCode, projectTaskId} = this.props.match.params;
        this.props.getProjectTask(projectCode, projectTaskId, this.props.history)
    }
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-8 m-auto">
                            ...
                            <p className="lead text-center">{this.state.projectIdentifier}: {this.state.id}</p>
